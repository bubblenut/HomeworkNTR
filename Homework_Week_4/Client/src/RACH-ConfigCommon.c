...
static asn_per_constraints_t asn_PER_type_edt_SmallTBS_Subset_r15_constr_77 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_edt_SmallTBS_Subset_r15_value2enum_77[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_edt_SmallTBS_Subset_r15_enum2value_77[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_edt_SmallTBS_Subset_r15_specs_77 = {
	asn_MAP_edt_SmallTBS_Subset_r15_value2enum_77,	/* "tag" => N; sorted by tag */
	asn_MAP_edt_SmallTBS_Subset_r15_enum2value_77,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_edt_SmallTBS_Subset_r15_tags_77[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_edt_SmallTBS_Subset_r15_77 = {
	"edt-SmallTBS-Subset-r15",
	"edt-SmallTBS-Subset-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_edt_SmallTBS_Subset_r15_tags_77,
	sizeof(asn_DEF_edt_SmallTBS_Subset_r15_tags_77)
		/sizeof(asn_DEF_edt_SmallTBS_Subset_r15_tags_77[0]) - 1, /* 1 */
	asn_DEF_edt_SmallTBS_Subset_r15_tags_77,	/* Same as above */
	sizeof(asn_DEF_edt_SmallTBS_Subset_r15_tags_77)
		/sizeof(asn_DEF_edt_SmallTBS_Subset_r15_tags_77[0]), /* 2 */
	{ 0, &asn_PER_type_edt_SmallTBS_Subset_r15_constr_77, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_edt_SmallTBS_Subset_r15_specs_77	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_RACH_ConfigCommon_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct RACH_ConfigCommon, preambleTransMax_CE_r13),
	...
	{ ATF_POINTER, 2, offsetof(struct RACH_ConfigCommon, rach_CE_LevelInfoList_r13),
	...
	{ ATF_POINTER, 1, offsetof(struct RACH_ConfigCommon, edt_SmallTBS_Subset_r15),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_edt_SmallTBS_Subset_r15_77,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"edt-SmallTBS-Subset-r15"
...
static const int asn_MAP_RACH_ConfigCommon_oms_1[] = { 4, 5, 6 };
...
static const asn_TYPE_tag2member_t asn_MAP_RACH_ConfigCommon_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* edt-SmallTBS-Subset-r15 */
};
