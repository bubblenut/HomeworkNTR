...
static asn_per_constraints_t asn_PER_type_verticalVelocityInfo_r15_constr_14 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_verticalVelocityInfo_r15_14[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LocationInfo_r10__verticalVelocityInfo_r15, choice.verticalVelocity_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LocationInfo_r10__verticalVelocityInfo_r15, choice.verticalVelocityAndUncertainty_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
...
static const asn_TYPE_tag2member_t asn_MAP_verticalVelocityInfo_r15_tag2el_14[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* verticalVelocity-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* verticalVelocityAndUncertainty-r15 */
};
static asn_CHOICE_specifics_t asn_SPC_verticalVelocityInfo_r15_specs_14 = {
	sizeof(struct LocationInfo_r10__verticalVelocityInfo_r15),
	offsetof(struct LocationInfo_r10__verticalVelocityInfo_r15, _asn_ctx),
	offsetof(struct LocationInfo_r10__verticalVelocityInfo_r15, present),
	sizeof(((struct LocationInfo_r10__verticalVelocityInfo_r15 *)0)->present),
	asn_MAP_verticalVelocityInfo_r15_tag2el_14,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_verticalVelocityInfo_r15_14 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_verticalVelocityInfo_r15_constr_14, CHOICE_constraint },
	asn_MBR_verticalVelocityInfo_r15_14,
	2,	/* Elements count */
	&asn_SPC_verticalVelocityInfo_r15_specs_14	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_LocationInfo_r10_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LocationInfo_r10, verticalVelocityInfo_r15),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_verticalVelocityInfo_r15_14,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"verticalVelocityInfo-r15"
...
static const asn_TYPE_tag2member_t asn_MAP_LocationInfo_r10_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 } /* verticalVelocityInfo-r15 */
};
