...
asn_TYPE_member_t asn_MBR_RadioResourceConfigDedicatedSCell_r10_1[] = {
	{ ATF_POINTER, 8, offsetof(struct RadioResourceConfigDedicatedSCell_r10, physicalConfigDedicatedSCell_r10),
	...
	{ ATF_POINTER, 7, offsetof(struct RadioResourceConfigDedicatedSCell_r10, mac_MainConfigSCell_r11),
	...
	{ ATF_POINTER, 6, offsetof(struct RadioResourceConfigDedicatedSCell_r10, naics_Info_r12),
	...
	{ ATF_POINTER, 5, offsetof(struct RadioResourceConfigDedicatedSCell_r10, neighCellsCRS_InfoSCell_r13),
	...
	{ ATF_POINTER, 4, offsetof(struct RadioResourceConfigDedicatedSCell_r10, physicalConfigDedicatedSCell_v1370),
	...
	{ ATF_POINTER, 3, offsetof(struct RadioResourceConfigDedicatedSCell_r10, crs_IntfMitigEnabled_r15),
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigDedicatedSCell_r10, neighCellsCRS_Info_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigDedicatedSCell_r10, sps_Config_v1530),
...
static const int asn_MAP_RadioResourceConfigDedicatedSCell_r10_oms_1[] = { 0, 1, 2, 3, 4, 5, 6, 7 };
...
static const asn_TYPE_tag2member_t asn_MAP_RadioResourceConfigDedicatedSCell_r10_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* crs-IntfMitigEnabled-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* neighCellsCRS-Info-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* sps-Config-v1530 */
};
