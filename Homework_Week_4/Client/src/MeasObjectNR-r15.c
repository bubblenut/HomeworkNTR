...
asn_TYPE_descriptor_t asn_DEF_bandNR_r15_16 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_bandNR_r15_constr_16, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_MeasObjectNR_r15_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct MeasObjectNR_r15, cellsForWhichToReportSFTD_r15),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct MeasObjectNR_r15, cellForWhichToReportCGI_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct MeasObjectNR_r15, deriveSSB_IndexFromCell_r15),
	...
	{ ATF_POINTER, 2, offsetof(struct MeasObjectNR_r15, ss_RSSI_Measurement_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct MeasObjectNR_r15, bandNR_r15),
...
static const int asn_MAP_MeasObjectNR_r15_oms_1[] = { 2, 3, 4, 5, 6, 8, 9, 10, 11, 12 };
