...
typedef enum SL_V2X_ConfigDedicated_r14__commTxResources_v1530_PR {
	SL_V2X_ConfigDedicated_r14__commTxResources_v1530_PR_NOTHING,	/* No components present */
	SL_V2X_ConfigDedicated_r14__commTxResources_v1530_PR_release,
	SL_V2X_ConfigDedicated_r14__commTxResources_v1530_PR_setup
} SL_V2X_ConfigDedicated_r14__commTxResources_v1530_PR;
typedef enum SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup_PR {
	SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup_PR_NOTHING,	/* No components present */
	SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup_PR_scheduled_v1530,
	SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup_PR_ue_Selected_v1530
} SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup_PR;
typedef enum SL_V2X_ConfigDedicated_r14__slss_TxMultiFreq_r15 {
	SL_V2X_ConfigDedicated_r14__slss_TxMultiFreq_r15_true	= 0
} e_SL_V2X_ConfigDedicated_r14__slss_TxMultiFreq_r15;
typedef enum SL_V2X_ConfigDedicated_r14__slss_TxDisabled_r15 {
	SL_V2X_ConfigDedicated_r14__slss_TxDisabled_r15_true	= 0
} e_SL_V2X_ConfigDedicated_r14__slss_TxDisabled_r15;
...
typedef struct SL_V2X_ConfigDedicated_r14 {
	 ...
	 */
	struct SL_V2X_ConfigDedicated_r14__commTxResources_v1530 {
		SL_V2X_ConfigDedicated_r14__commTxResources_v1530_PR present;
		union SL_V2X_ConfigDedicated_r14__commTxResources_v1530_u {
			NULL_t	 release;
			struct SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup {
				SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup_PR present;
				union SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup_u {
					struct SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup__scheduled_v1530 {
					...
					struct SL_V2X_ConfigDedicated_r14__commTxResources_v1530__setup__ue_Selected_v1530 {
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_slss_TxMultiFreq_r15_31;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_slss_TxDisabled_r15_33;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_SL_V2X_ConfigDedicated_r14_1[10];
