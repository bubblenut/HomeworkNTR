...
asn_TYPE_member_t asn_MBR_SL_V2X_PreconfigFreqInfo_r14_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SL_V2X_PreconfigFreqInfo_r14, v2x_FreqSelectionConfigList_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_SL_V2X_PreconfigFreqInfo_r14_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (10 << 2)), 10, 0, 0 } /* v2x-FreqSelectionConfigList-r15 */
};
