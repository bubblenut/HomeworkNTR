...
asn_TYPE_member_t asn_MBR_RRM_Config_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RRM_Config, candidateCellInfoList_r10),
	...
	{ ATF_POINTER, 1, offsetof(struct RRM_Config, candidateCellInfoListNR_r15),
...
static const asn_TYPE_tag2member_t asn_MAP_RRM_Config_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* candidateCellInfoListNR-r15 */
};
