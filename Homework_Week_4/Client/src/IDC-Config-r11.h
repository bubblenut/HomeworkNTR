...
typedef enum IDC_Config_r11__idc_Indication_MRDC_r15_PR {
	IDC_Config_r11__idc_Indication_MRDC_r15_PR_NOTHING,	/* No components present */
	IDC_Config_r11__idc_Indication_MRDC_r15_PR_release,
	IDC_Config_r11__idc_Indication_MRDC_r15_PR_setup
} IDC_Config_r11__idc_Indication_MRDC_r15_PR;
...
typedef struct IDC_Config_r11 {
	...
	struct IDC_Config_r11__idc_Indication_MRDC_r15 {
		IDC_Config_r11__idc_Indication_MRDC_r15_PR present;
		union IDC_Config_r11__idc_Indication_MRDC_r15_u {
			NULL_t	 release;
