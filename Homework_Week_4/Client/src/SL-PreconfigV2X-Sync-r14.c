...
static asn_per_constraints_t asn_PER_type_slss_TxDisabled_r15_constr_20 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_slss_TxDisabled_r15_value2enum_20[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_slss_TxDisabled_r15_enum2value_20[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_slss_TxDisabled_r15_specs_20 = {
	asn_MAP_slss_TxDisabled_r15_value2enum_20,	/* "tag" => N; sorted by tag */
	asn_MAP_slss_TxDisabled_r15_enum2value_20,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_slss_TxDisabled_r15_tags_20[] = {
	(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_slss_TxDisabled_r15_20 = {
	"slss-TxDisabled-r15",
	"slss-TxDisabled-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_slss_TxDisabled_r15_tags_20,
	sizeof(asn_DEF_slss_TxDisabled_r15_tags_20)
		/sizeof(asn_DEF_slss_TxDisabled_r15_tags_20[0]) - 1, /* 1 */
	asn_DEF_slss_TxDisabled_r15_tags_20,	/* Same as above */
	sizeof(asn_DEF_slss_TxDisabled_r15_tags_20)
		/sizeof(asn_DEF_slss_TxDisabled_r15_tags_20[0]), /* 2 */
	{ 0, &asn_PER_type_slss_TxDisabled_r15_constr_20, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_slss_TxDisabled_r15_specs_20	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SL_PreconfigV2X_Sync_r14_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct SL_PreconfigV2X_Sync_r14, slss_TxDisabled_r15),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_slss_TxDisabled_r15_20,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"slss-TxDisabled-r15"
...
static const asn_TYPE_tag2member_t asn_MAP_SL_PreconfigV2X_Sync_r14_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 } /* slss-TxDisabled-r15 */
};
