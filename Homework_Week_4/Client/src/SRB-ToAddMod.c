...
static int
memb_srb_Identity_v1530_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_type_pdcp_verChange_r15_constr_10 CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_srb_Identity_v1530_constr_14 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_pdcp_verChange_r15_value2enum_10[] = {
	{ 0,	4,	"true" }
};
static const unsigned int asn_MAP_pdcp_verChange_r15_enum2value_10[] = {
	0	/* true(0) */
};
static const asn_INTEGER_specifics_t asn_SPC_pdcp_verChange_r15_specs_10 = {
	asn_MAP_pdcp_verChange_r15_value2enum_10,	/* "tag" => N; sorted by tag */
	asn_MAP_pdcp_verChange_r15_enum2value_10,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_pdcp_verChange_r15_tags_10[] = {
	(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_pdcp_verChange_r15_10 = {
	"pdcp-verChange-r15",
	"pdcp-verChange-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_pdcp_verChange_r15_tags_10,
	sizeof(asn_DEF_pdcp_verChange_r15_tags_10)
		/sizeof(asn_DEF_pdcp_verChange_r15_tags_10[0]) - 1, /* 1 */
	asn_DEF_pdcp_verChange_r15_tags_10,	/* Same as above */
	sizeof(asn_DEF_pdcp_verChange_r15_tags_10)
		/sizeof(asn_DEF_pdcp_verChange_r15_tags_10[0]), /* 2 */
	{ 0, &asn_PER_type_pdcp_verChange_r15_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_pdcp_verChange_r15_specs_10	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SRB_ToAddMod_1[] = {
	...
	{ ATF_POINTER, 7, offsetof(struct SRB_ToAddMod, rlc_Config),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct SRB_ToAddMod, logicalChannelConfig),
	...
	{ ATF_POINTER, 5, offsetof(struct SRB_ToAddMod, pdcp_verChange_r15),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_pdcp_verChange_r15_10,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"pdcp-verChange-r15"
		},
	{ ATF_POINTER, 4, offsetof(struct SRB_ToAddMod, rlc_Config_v1530),
	...
	{ ATF_POINTER, 3, offsetof(struct SRB_ToAddMod, rlc_BearerConfigSecondary_r15),
	...
	{ ATF_POINTER, 2, offsetof(struct SRB_ToAddMod, srb_Identity_v1530),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_srb_Identity_v1530_constr_14,  memb_srb_Identity_v1530_constraint_1 },
		0, 0, /* No default value */
		"srb-Identity-v1530"
		},
	{ ATF_POINTER, 1, offsetof(struct SRB_ToAddMod, rlc_Config_v1560),
...
static const int asn_MAP_SRB_ToAddMod_oms_1[] = { 1, 2, 3, 4, 5, 6, 7 };
...
static const asn_TYPE_tag2member_t asn_MAP_SRB_ToAddMod_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* pdcp-verChange-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* rlc-Config-v1530 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 }, /* rlc-BearerConfigSecondary-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (6 << 2)), 6, 0, 0 }, /* srb-Identity-v1530 */
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* rlc-Config-v1560 */
};
