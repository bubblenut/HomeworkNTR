...
asn_TYPE_member_t asn_MBR_DL_CarrierConfigCommon_NB_r14_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct DL_CarrierConfigCommon_NB_r14, dl_GapNonAnchor_v1530),
	...
	{ ATF_POINTER, 1, offsetof(struct DL_CarrierConfigCommon_NB_r14, dl_CarrierFreq_v1550),
