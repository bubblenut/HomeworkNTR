...
static asn_per_constraints_t asn_PER_type_sCellState_r15_constr_12 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_sCellState_r15_value2enum_12[] = {
	{ 0,	9,	"activated" },
	{ 1,	7,	"dormant" }
};
static const unsigned int asn_MAP_sCellState_r15_enum2value_12[] = {
	0,	/* activated(0) */
	1	/* dormant(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_sCellState_r15_specs_12 = {
	asn_MAP_sCellState_r15_value2enum_12,	/* "tag" => N; sorted by tag */
	asn_MAP_sCellState_r15_enum2value_12,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_sCellState_r15_tags_12[] = {
	(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_sCellState_r15_12 = {
	"sCellState-r15",
	"sCellState-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_sCellState_r15_tags_12,
	sizeof(asn_DEF_sCellState_r15_tags_12)
		/sizeof(asn_DEF_sCellState_r15_tags_12[0]) - 1, /* 1 */
	asn_DEF_sCellState_r15_tags_12,	/* Same as above */
	sizeof(asn_DEF_sCellState_r15_tags_12)
		/sizeof(asn_DEF_sCellState_r15_tags_12[0]), /* 2 */
	{ 0, &asn_PER_type_sCellState_r15_constr_12, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_sCellState_r15_specs_12	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_SCellToAddMod_r10_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct SCellToAddMod_r10, dl_CarrierFreq_v1090),
	...
	{ ATF_POINTER, 3, offsetof(struct SCellToAddMod_r10, antennaInfoDedicatedSCell_v10i0),
	...
	{ ATF_POINTER, 2, offsetof(struct SCellToAddMod_r10, srs_SwitchFromServCellIndex_r14),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_srs_SwitchFromServCellIndex_r14_constr_11,  memb_srs_SwitchFromServCellIndex_r14_constraint_1 },
		0, 0, /* No default value */
		"srs-SwitchFromServCellIndex-r14"
		},
	{ ATF_POINTER, 1, offsetof(struct SCellToAddMod_r10, sCellState_r15),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_sCellState_r15_12,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"sCellState-r15"
...
static const asn_TYPE_tag2member_t asn_MAP_SCellToAddMod_r10_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* sCellState-r15 */
};
