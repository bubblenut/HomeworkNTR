...
asn_TYPE_member_t asn_MBR_PSCellToAddMod_r12_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct PSCellToAddMod_r12, antennaInfoDedicatedPSCell_v1280),
	...
	{ ATF_POINTER, 3, offsetof(struct PSCellToAddMod_r12, sCellIndex_r13),
	...
	{ ATF_POINTER, 2, offsetof(struct PSCellToAddMod_r12, radioResourceConfigDedicatedPSCell_v1370),
	...
	{ ATF_POINTER, 1, offsetof(struct PSCellToAddMod_r12, radioResourceConfigDedicatedPSCell_v13c0),
...
static const asn_TYPE_tag2member_t asn_MAP_PSCellToAddMod_r12_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (7 << 2)), 7, 0, 0 } /* radioResourceConfigDedicatedPSCell-v13c0 */
};
