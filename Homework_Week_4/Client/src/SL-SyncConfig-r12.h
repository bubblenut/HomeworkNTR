...
typedef enum SL_SyncConfig_r12__slss_TxDisabled_r15 {
	SL_SyncConfig_r12__slss_TxDisabled_r15_true	= 0
} e_SL_SyncConfig_r12__slss_TxDisabled_r15;
...
extern asn_TYPE_member_t asn_MBR_SL_SyncConfig_r12_1[11];
