...
typedef enum SL_SyncConfigNFreq_r13__slss_TxDisabled_r15 {
	SL_SyncConfigNFreq_r13__slss_TxDisabled_r15_true	= 0
} e_SL_SyncConfigNFreq_r13__slss_TxDisabled_r15;
...
/* extern asn_TYPE_descriptor_t asn_DEF_slss_TxDisabled_r15_22;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_SL_SyncConfigNFreq_r13_1[8];
