...
asn_TYPE_member_t asn_MBR_AS_Context_v1130_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct AS_Context_v1130, sidelinkUEInformation_r12),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_sidelinkUEInformation_r12_constr_6,  memb_sidelinkUEInformation_r12_constraint_1 },
		0, 0, /* No default value */
		"sidelinkUEInformation-r12"
		},
	{ ATF_POINTER, 2, offsetof(struct AS_Context_v1130, sourceContextEN_DC_r15),
	...
	{ ATF_POINTER, 1, offsetof(struct AS_Context_v1130, selectedbandCombinationInfoEN_DC_v1540),
...
static const asn_TYPE_tag2member_t asn_MAP_AS_Context_v1130_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 }, /* sourceContextEN-DC-r15 */
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* selectedbandCombinationInfoEN-DC-v1540 */
};
