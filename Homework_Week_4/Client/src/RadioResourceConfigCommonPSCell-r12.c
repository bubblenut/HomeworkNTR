...
asn_TYPE_member_t asn_MBR_RadioResourceConfigCommonPSCell_r12_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct RadioResourceConfigCommonPSCell_r12, uplinkPowerControlCommonPSCell_v1310),
	...
	{ ATF_POINTER, 1, offsetof(struct RadioResourceConfigCommonPSCell_r12, uplinkPowerControlCommonPSCell_v1530),
...
static const asn_TYPE_tag2member_t asn_MAP_RadioResourceConfigCommonPSCell_r12_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (5 << 2)), 5, 0, 0 } /* uplinkPowerControlCommonPSCell-v1530 */
};
