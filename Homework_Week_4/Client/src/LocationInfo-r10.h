...
typedef enum LocationInfo_r10__verticalVelocityInfo_r15_PR {
	LocationInfo_r10__verticalVelocityInfo_r15_PR_NOTHING,	/* No components present */
	LocationInfo_r10__verticalVelocityInfo_r15_PR_verticalVelocity_r15,
	LocationInfo_r10__verticalVelocityInfo_r15_PR_verticalVelocityAndUncertainty_r15
} LocationInfo_r10__verticalVelocityInfo_r15_PR;
...
typedef struct LocationInfo_r10 {
	 ...
	 * possible extensions are below.
	 */
	struct LocationInfo_r10__verticalVelocityInfo_r15 {
		LocationInfo_r10__verticalVelocityInfo_r15_PR present;
		union LocationInfo_r10__verticalVelocityInfo_r15_u {
