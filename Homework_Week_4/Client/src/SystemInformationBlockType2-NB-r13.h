...
typedef enum SystemInformationBlockType2_NB_r13__enhancedPHR_r15 {
	SystemInformationBlockType2_NB_r13__enhancedPHR_r15_true	= 0
} e_SystemInformationBlockType2_NB_r13__enhancedPHR_r15;
typedef enum SystemInformationBlockType2_NB_r13__cp_EDT_r15 {
	SystemInformationBlockType2_NB_r13__cp_EDT_r15_true	= 0
} e_SystemInformationBlockType2_NB_r13__cp_EDT_r15;
typedef enum SystemInformationBlockType2_NB_r13__up_EDT_r15 {
	SystemInformationBlockType2_NB_r13__up_EDT_r15_true	= 0
} e_SystemInformationBlockType2_NB_r13__up_EDT_r15;
...
typedef struct SystemInformationBlockType2_NB_r13 {
	...
	struct SystemInformationBlockType2_NB_r13__freqInfo_v1530 {
...
/* extern asn_TYPE_descriptor_t asn_DEF_enhancedPHR_r15_18;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_cp_EDT_r15_22;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_up_EDT_r15_24;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_SystemInformationBlockType2_NB_r13_1[13];
