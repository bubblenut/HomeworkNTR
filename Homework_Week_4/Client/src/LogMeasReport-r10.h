...
typedef enum LogMeasReport_r10__logMeasAvailableBT_r15 {
	LogMeasReport_r10__logMeasAvailableBT_r15_true	= 0
} e_LogMeasReport_r10__logMeasAvailableBT_r15;
typedef enum LogMeasReport_r10__logMeasAvailableWLAN_r15 {
	LogMeasReport_r10__logMeasAvailableWLAN_r15_true	= 0
} e_LogMeasReport_r10__logMeasAvailableWLAN_r15;
...
/* extern asn_TYPE_descriptor_t asn_DEF_logMeasAvailableBT_r15_10;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_logMeasAvailableWLAN_r15_12;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_LogMeasReport_r10;
extern asn_SEQUENCE_specifics_t asn_SPC_LogMeasReport_r10_specs_1;
extern asn_TYPE_member_t asn_MBR_LogMeasReport_r10_1[8];
