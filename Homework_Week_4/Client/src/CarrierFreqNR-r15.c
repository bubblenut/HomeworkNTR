...
asn_TYPE_member_t asn_MBR_CarrierFreqNR_r15_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct CarrierFreqNR_r15, maxRS_IndexCellQual_r15),
	...
	{ ATF_POINTER, 4, offsetof(struct CarrierFreqNR_r15, threshRS_Index_r15),
	...
	{ ATF_POINTER, 3, offsetof(struct CarrierFreqNR_r15, multiBandNsPmaxListNR_v1550),
	...
	{ ATF_POINTER, 2, offsetof(struct CarrierFreqNR_r15, multiBandNsPmaxListNR_SUL_v1550),
	...
	{ ATF_POINTER, 1, offsetof(struct CarrierFreqNR_r15, ssb_ToMeasure_r15),
...
static const int asn_MAP_CarrierFreqNR_r15_oms_1[] = { 1, 2, 3, 5, 6, 7, 10, 12, 14, 15, 17, 18, 19, 20, 21 };
...
static const asn_TYPE_tag2member_t asn_MAP_CarrierFreqNR_r15_tag2el_1[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (19 << 2)), 19, 0, 0 }, /* multiBandNsPmaxListNR-v1550 */
    { (ASN_TAG_CLASS_CONTEXT | (20 << 2)), 20, 0, 0 }, /* multiBandNsPmaxListNR-SUL-v1550 */
    { (ASN_TAG_CLASS_CONTEXT | (21 << 2)), 21, 0, 0 } /* ssb-ToMeasure-r15 */
};
